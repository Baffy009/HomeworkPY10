...
def init_data_base(file_name='db.csv', encoding='utf-8'):
    global global_id
    global db
    global db_file_name
...
def create(name='', surname='', number='', email='', encoding='utf-8'):
    global global_id
    global db
    global db_file_name
    if(name == ''):
...
def retrive(id='', name='', surname='', number='', email='', encoding='utf-8'):
    global global_id
    global db
    global db_file_name
    result = []
...
def update(id='', new_name='', new_surname='', new_number='', new_email='', encoding='utf-8'):
    global global_id
    global db
    global db_file_name
    if(id == ''):
