...
def warning(message, encoding='utf-8'):
    bot.send_message(
        message.chat.id, f'Я тебя не понимаю. Введи: /help.')


@bot.message_handler(commands=['start'])
def start(message, encoding='utf-8'):
    bot.send_message(
...
def help(message, encoding='utf-8'):
    bot.send_message(
...
def main(message, encoding='utf-8'):
...
def find_surname(message, encoding='utf-8'):
    global surname_it
...
def find_name(message, encoding='utf-8'):
    global name_it
...
def find_number(message, encoding='utf-8'):
    global number_it
...
def get_name(message, encoding='utf-8'):
    global name_it
    name_it = message.text
    lg.logging.info('User entered: {name_it}')
    bot.send_message(message.chat.id, f'Введите фамилию')
...
def get_surname(message, encoding='utf-8'):
    global surname_it
    surname_it = message.text
    lg.logging.info('User entered: {surname_it}')
    bot.send_message(message.chat.id, f'Введите номер телефона')
...
def get_number(message, encoding='utf-8'):
    global number_it
    number_it = message.text
    lg.logging.info('User entered: {number_it}')
...
def get_email(message, encoding='utf-8'):
    global email_it
...
def edit_entry(message, encoding='utf-8'):
    if message.text == '/61':
...
def change_name(message, encoding='utf-8'):
    global name_it
    name_it = message.text
    lg.logging.info('User entered: {name_it}')
    bot.send_message(message.chat.id, f'{cr.retrive(name=name_it)}')
...
def change_surname(message, encoding='utf-8'):
    global surname_it
    surname_it = message.text
    lg.logging.info('User entered: {surname_it}')
    bot.send_message(message.chat.id, f'{cr.retrive(surname=surname_it)}')
...
def change_num(message, encoding='utf-8'):
    global number_it
    number_it = message.text
    lg.logging.info('User entered: {number_it}')
    bot.send_message(message.chat.id, f'{cr.retrive(number=number_it)}')
...
def change_number(message, encoding='utf-8'):
    global user_id_it
...
def change_new_number(message, encoding='utf-8'):
...
def delete_contact(message, encoding='utf-8'):
    if message.text == '/71':
...
def delete_surname(message, encoding='utf-8'):
    global surname_it
    surname_it = message.text
    lg.logging.info('User entered: {surname_it}')
    bot.send_message(message.chat.id, f'{cr.retrive(surname=surname_it)}')
...
def delete_name(message, encoding='utf-8'):
    global name_it
    name_it = message.text
    lg.logging.info('User entered: {name_it}')
    bot.send_message(message.chat.id, f'{cr.retrive(name=name_it)}')
...
def delete_num(message, encoding='utf-8'):
    global number_it
    number_it = message.text
    lg.logging.info('User entered: {number_it}')
    bot.send_message(message.chat.id, f'{cr.retrive(number=number_it)}')
...
def delete_number(message, encoding='utf-8'):
    global user_id_it
    user_id_it = message.text
    lg.logging.info('User entered: {user_id_it}')
